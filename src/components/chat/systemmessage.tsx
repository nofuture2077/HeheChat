...
const messages = {
    ...
    'sub_1000': '$1 subscribed to $0 for $2 months///$4',
    'sub_2000': '$1 subscribed with Tier 2 to $0 for $2 months///$4',
    'sub_3000': '$1 subscribed with Tier 3 to $0 for $2 months///$4',
    ...
    'sub_Prime': '$1 subscribed with prime to $0 for $2 months///$4',
...
export function SystemMessageComp(props: SystemMessageProps) {
    ...
    return <div className={[classes.msg, classes[props.msg.subType]].join(' ')}><Text fw={900} {...p}>{textParts[0]}</Text>{textParts.length === 2 ? <Text fw={500}>{parseMessage(textParts[1]).text}</Text>: null}{actions}</div>;
}