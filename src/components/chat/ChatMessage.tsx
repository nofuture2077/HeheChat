...
const importantBadgeIndex = ['moderator', 'lead_moderator', 'vip', 'staff', 'partner', 'broadcaster', 'ambassador'].reduce((obj: any, key: string) => {obj[key] = 'showImportantBadges'; return obj}, {});
