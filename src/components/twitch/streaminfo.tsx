import { Button, Group, Title, TextInput, MultiSelect, Switch, NumberInput, Combobox, InputBase, Image, Text, Flex, useCombobox } from '@mantine/core';
...
export function StreamInfo({ close }: StreamInfoProps) {
    ...
    return (
        <nav style={{ width: '100%', height: '100%', padding: '20px' }}>
