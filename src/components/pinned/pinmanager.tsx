...
export function PinManager() {
    ...
    //    {expanded: true, hidden: false, type: 'adbreak', id: '1', endTime: new Date(Date.now() + 5*1000*60), channel: 'nofuture2077', data: {onClick: () => {}}},
    //    {expanded: true, hidden: false, type: 'shoutout', id: '5', endTime: new Date(Date.now() + 5*1000*60), channel: 'nofuture2077', data: {    broadcasterName: 'nofuture2077', targetUserName: 'jonsman', viewerCount: 1224,moderatorName: 'nofuture2077'}},
    //    {expanded: true, hidden: false, type: 'hypetrain', id: '4', endTime: new Date(Date.now() + 5*1000*60), channel: 'nofuture2077', data: {level: 7, progress: 2323, goal: 4356, state: 'active'}},
    //    {expanded: true, hidden: false, type: 'hypetrain', id: '9', endTime: new Date(Date.now() + 5*1000*60), channel: 'nofuture2077', data: {level: 7, progress: 4200, goal: 4356, state: 'active', isGoldenKappaTrain: true}},
    //    {expanded: false, hidden: false, type: 'poll', id: '6', endTime: new Date(Date.now() + 5*1000*60), channel: 'nofuture2077', data: {title: 'was esst ihr lieber?', winningChoice: {title: 'Nutella', totalVotes: 43}, options: [{title: 'Nutella', totalVotes: 43}, {title: 'Marmelade', totalVotes: 7}], state: 'ended'}},
    //    {expanded: false, hidden: false, type: 'prediction', id: '7', endTime: new Date(Date.now() + 5*1000*60), channel: 'nofuture2077', data: {title: 'was esst ihr lieber?', winningOutcomes: {title: 'Nutella', channelPoints: 31343, users: 23}, outcomes: [{title: 'Nutella', channelPoints: 31343, users: 23}, {title: 'Marmelande', channelPoints: 23132, users: 12}, {title: 'Obst', channelPoints: 2222, users: 1}], state: 'active'}},
    //    {expanded: true, hidden: false, type: 'raid', id: '8', endTime: new Date(Date.now() + 5*1000*60), channel: 'nofuture2077', data: { broadcasterName: 'z0kka', targetChannelName: 'nofuture2077', viewers: 1242}},
    ]);
